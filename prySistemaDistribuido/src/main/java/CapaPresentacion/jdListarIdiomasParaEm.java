...
public class jdListarIdiomasParaEm extends javax.swing.JDialog {
     ...
     */
    public jdListarIdiomasParaEm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("IDIOMAS DE POSTULANTES");

        cboTipoB.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cboTipoB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Idioma", "Nivel" }));
    ...
    private void txtBusquedaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBusquedaKeyReleased
        ...
        if(busqueda.equalsIgnoreCase("Idioma")){
            busquedaFiltradaPostulantePorIdioma(txtBusqueda.getText());
        }else{
            busquedaFiltradaPostulantePorNivel(txtBusqueda.getText());
        }
    ...
    public void listarIdiomas(){
            try {
            objIdiomas.listarIdioma(tblIdiomas);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdListarIdiomasParaEm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdListarIdiomasParaEm dialog = new jdListarIdiomasParaEm(new javax.swing.JFrame(), true);
